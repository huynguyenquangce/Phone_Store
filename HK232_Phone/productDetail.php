...
if ($result_rating_avg && $result_rating_avg->num_rows > 0) {
  ...
  $sql_update_rating = "UPDATE product SET rating_tb = $rating_avg WHERE products_id = $id";
        ...
        <div class="container" style="padding: 0 10px;">
            ...
            <div class="col-lg-6 col-md-12  rounded product_info_left">
              ...
              <ul class="list-group mb-3">
                <li class="list-group-item p-3">
                  ...
                  Bộ sản phẩm gồm: Dây nguồn, Sách hướng dẫn, Bộ sạc
                </li>
                <li class="list-group-item p-3">
                  <span>
                ...
                <li class="list-group-item p-3">
                  ...
                  Bảo hành chính hãng điện thoại <b>2 năm</b> tại các trung tâm bảo hành hãng
                </li>
              </ul>
            </div>
          ...
          <div class="row gx-5 product-detail product-section">
            ...
            <div class="col-lg-6 rounded ">
              <img src="./img/iphone_detail.jpg" class="d-block w-100" alt="No image">
            </div>
            <div class="col-lg-6 rounded ">
          ...
          <div class="row gx-5 product-suggestions__wrap product-section">
            ...
            <div class="product-suggestions">
              <?php
              $sql_products_random = "SELECT products_id, products_name, price, discount, image FROM product  ORDER BY RAND() LIMIT 6";
