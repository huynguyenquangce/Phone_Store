...
$sql = "SELECT brand_name FROM brand WHERE brand_id = $id"; // lựa chọn sản phẩm có brand_id = id
$result_sql = $conn->query($sql);
$row_name = $result_sql->fetch_assoc();



$sql_prd_id = "SELECT brand_id FROM brand";
            ...
            <div class="container" style="padding: 0 10px;">
                <div class="products">
                    <div class="products-wrap">
                        ...
                        <?php
                        $sql_product = "SELECT * FROM product WHERE brand_id = '$id'";
